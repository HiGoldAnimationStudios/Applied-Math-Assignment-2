...
function update_leg_drawing(vertex_coords_root, leg_drawing, leg_params)
    ...
    vertex_coords_mat=column_to_matrix(vertex_coords_root);
    ...
    for linkage_index = 1:leg_params.num_linkages
        ...
        %your code here
        a_vertex=link_to_vertex_list(linkage_index,1);
        b_vertex=link_to_vertex_list(linkage_index,2);
        ...
        line_x = [x_a, x_b];%your code here
        line_y = [y_a, y_b];%your code here
    ...
    for vertex_index = 1:leg_params.num_vertices
        ...
        %your code here
        x_i=vertex_coords_mat(vertex_index,1);
        y_i=vertex_coords_mat(vertex_index,2);
    ...
    crank_x = [x0,x1];%your code here
    crank_y = [y0,y1];%your code here
